...
return {status: "sukses", author: "iwan", result : {title:data.data.data.title,linkUnblock:`${mainUrl}${data.data.data.play}`,link:`${mainUrl}${data.data.data.hdplay}`,musik:`${mainUrl}${data.data.data.music}`} }
 }else{
