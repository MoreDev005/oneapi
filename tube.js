...
let linknya = await ytdownload.ytmp3(urlyt,'128')
return {status: "sukses", author: "iwan", result: {link:linknya.download.url,linkUnblock:`${baseUrl}/download/id?data=${encodeURIComponent(linknya.download.url)}`}}
