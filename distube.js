...
return {status: "sukses", author: "iwan", result: {link:`${baseUrl}/download/id?data=${encodeURIComponent(audioUrl)}`,linkUnblock:`${baseUrl}/download/id?data=${encodeURIComponent(audioUrl)}`}}
}catch(e){
